...
// import 'package:good_trip/core/data/models/tour/audio_tour_dto.dart';
...
//     final response = await DioClient().apiDio.get(
...
//     //int rate = data['rate'];
//     List<String> kinds = [];
//     for (final String el in data['kinds'].split(',')) {
//       final element = TourType.values.byName(el);
//       kinds.add(element.displayText);
//       // if (kindsMap[el] != null) {
...
//   }
//
//   Future<List<AudioTourDto>> getAudioTourList(
...
//
//     final response = await TourService
//         .getToursByCity(userId: userId.toString(), city: city, offset: offset);
...
//
//     List<AudioTour> tours = [];
//     for (final Map<String, dynamic> actData in data) {
//       tours.add(AudioTour.fromJson(actData));
//     }
//     return tours;
//   }

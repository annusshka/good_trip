...
class ExcursionListPresenter2 {
  ...
  final BehaviorSubject<List<MediaItem>> mediaItemList = BehaviorSubject.seeded([]);

  Future<void> init() async {
    final List<MediaItem> mediaItems = await excursionsToMediaItems(excursionList as List<AudioExcursion>);

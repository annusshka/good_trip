...
part of 'account_list_service.dart';
...
class _AccountListService implements AccountListService {
  _AccountListService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<List<UserDto>> getAccountList() async {
  ...
  @override
  Future<void> removeAccount({required int accountId}) async {
    const _extra = <String, dynamic>{};
